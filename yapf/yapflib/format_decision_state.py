    ...
    def __eq__( self, other ):
        ...
        return (
            ...
            self.lowest_level_on_line == other.lowest_level_on_line and (
                self.ignore_stack_for_comparison or other.ignore_stack_for_comparison or
                self.stack == other.stack and self.comp_stack == other.comp_stack and
        ...
        if ( style.Get( 'SPLIT_BEFORE_NAMED_ASSIGNS' ) and not current.is_comment and
            ...
            if ( previous.value not in { '=', ':', '*', '**' } and
                ...
                if previous.value == '(':
                    ...
                    if ( not style.Get( 'SPLIT_BEFORE_EXPRESSION_AFTER_OPENING_PAREN' )
